...
a Raspberry Pi. The modules (see :ref:`360pibot_API` ) of the implementation are using 
the pigpio_ module to control the GPIOs of the Raspberry Pi. No other external module 
is needed.
